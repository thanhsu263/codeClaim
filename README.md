...
2. Place the file in your server's `mods/` folder alongside Fabric API
3. Start the server — the config file will be automatically generated at `config/codeclaim.json`
4. Edit the config to define your codes and rewards
5. Use `/claimadmin reload` to apply any changes without restarting
